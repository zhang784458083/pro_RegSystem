...
<section id="single">
	...
	<form action="${pageContext.request.contextPath}/pay" method="post" class="form form-horizontal" id="form-member-add">
      ...
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red" ></span>您的当前可用余额：</label>
        <div class="formControls col-xs-8">
          <span><font color=black size="4px">${account}元</font></span>
        </div>
     	
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red" ></span>您需要充值的金额：</label>
        <div class="formControls col-xs-8">
          <input type="text" class="input-text" value="" placeholder="" id="p3_Amt" name="p3_Amt" style="width: 50px"><font color=black size="4px">&nbsp;元</font><font color=red size="3px">（注意：测试阶段，充值金额以分为单位，如：充值1元只需要输入0.01。）</font>
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red" ></span>请您选择银行：</label>
        <div class="formControls col-xs-8">
          <span>
     ...
     <div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input type="submit" class="btn btn-success radius size-L"  value="&nbsp;支付&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</div>
		</div>
