...
<header>
	...
	<div class="wrapper">
		<h1 class="logo">
			...
			<font size="6" color="white">e 挂号平台</font>
		</h1>
		<nav>
			<ul>
				<li class="home"><a href="pindex" >首页<span>网站首页</span></a></li>
				<c:if test="${not empty patient }">
					<li class="about"><a href="orderUI" title="平台服务 ">在线预约<span>我们能做什么 </span></a></li>
				</c:if>
				<c:if test="${empty patient }">
					<li class="about"><a href="ploginUI" title="平台服务 ">在线预约<span>我们能做什么 </span></a></li>
				</c:if>
				<li class="cases"><a href="sysabout" title="预约须知">预约须知<span>您如何操作</span></a></li>
				<li class="service"><a href="news" title="新闻资讯">最新公告<span>停诊信息 </span></a></li>
				
				<c:if test="${not empty patient }">
				<li class="client"><a href="pcenter"  title="个人中心">欢迎：${patient.pname}<span>我的账户</span></a></li>
				<li class="client"><a href="plogout"  title="退出系统">退出<span>重新登录</span></a></li>
				</c:if>
				<c:if test="${empty patient }">
				<li class="client"><a href="ploginUI"  title="个人中心">登录个人中心<span>马上注册</span></a></li>
