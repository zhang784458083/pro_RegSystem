...
<section id="single">
	...
	<div class="cat_title">
		<div class="wrapper">
			<h2>我的账户</h2>
			 <p><br/><br/><font size="3px">查看账户余额</font></p> 
		</div>
	</div> 
	...
	<form action="${pageContext.request.contextPath}/porder" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="formControls col-xs-8">
          ...
          <span><font color="blue" size="6px">充值成功！</font></span>
        	<%-- <input type="hidden" id="officeVal" value="${officeVal}"/> --%>
        </div>
     	
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red" ></span><font size="4px">成功充值：</font></label>
        <div class="formControls col-xs-8">
          <span><font color=black size="4px"><font size="4px">${r3_Amt}元</font></font></span>
        </div>
     	
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red" ></span><font size="4px">账户余额：</font></label>
        <div class="formControls col-xs-8">
          <span><font color=black size="4px"><font size="4px">${account} 元</font></font></span>
        </div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input onclick="window.location.href='orderUI'" class="btn btn-success radius size-L" type="button" class="btn btn-success radius size-L" value="&nbsp;预约挂号&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input onclick="window.location.href='pcenter'" class="btn btn-success radius size-L" type="button" class="btn btn-success radius size-L" value="&nbsp;个人中心&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</div>
		</div>
	</form>
