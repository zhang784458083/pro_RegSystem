...
<section id="single">
	...
	<article class="serv_detailed">
        ...
        <div class="formControls col-xs-8">
          <input id="username" name="userName" type="text" placeholder="用户名" class="input-text size-L">可用“数字、大小写英文字母”进行组合，（8-16个字符，不能含特殊符号）。
      ...
      <div class="row cl">
		...
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>生日：</label>
			...
			<font size="3px" >例如：1999-09-19</font>
        ...
        <div class="formControls col-xs-8 ">
          ...
          <img src="${pageContext.request.contextPath}/codeServlet" id="newcode"> <a id="kanbuq" href="javascript:;" >看不清，换一张</a> <font color="red" size="4px" >${message}</font></div>
...
function checkForm() {
    ...
    if (window.confirm("一旦注册后姓名和身份证号不得修改，你确认信息正确吗?")) {
     	return true;
    }
