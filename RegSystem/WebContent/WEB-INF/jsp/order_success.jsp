...
<section id="single">
	...
	<form action="${pageContext.request.contextPath}/porder" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="formControls col-xs-8">
          ...
          <span><font color="blue" size="6px">恭喜您，已经预约成功！</font></span>
        	<%-- <input type="hidden" id="officeVal" value="${officeVal}"/> --%>
        </div>
     	
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red" ></span>1.您的订单流水：</label>
        <div class="formControls col-xs-8">
       ...
       <!--  <label class="form-label col-xs-4 col-sm-3"><span class="c-red" >*请您牢记，</span></label> -->
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input onclick="window.location.href='orderUI'" class="btn btn-success radius size-L" type="button" value="&nbsp;继续预约&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
