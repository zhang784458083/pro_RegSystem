...
<section id="single">
	...
	<form action="${pageContext.request.contextPath}/porder" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="formControls col-xs-8">
          ...
          <span><font color="blue" size="6px">对不起，充值失败！</font></span>
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <span><font color=black size="4px">银行卡余额不足！</font></span>
        </div>
    ...
    <div class="row cl">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				...
				<input onclick="window.location.href='paccount'" class="btn btn-success radius size-L" type="button" class="btn btn-success radius size-L" value="&nbsp;重新充值&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</div>
		</div>
	</form>
