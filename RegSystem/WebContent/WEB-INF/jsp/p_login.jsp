	...
	<article class="serv_detailed">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <!-- <!-- <input  id="toreg" name="" type="button" class="btn btn-success radius size-L" value="&nbsp;注&nbsp;&nbsp;&nbsp;&nbsp;册&nbsp;" onclick="pindex"><br> --> 
          <!-- <button id="reg" class="btn btn-success radius size-L" onclick="window.location.href='/preg'">&nbsp;注&nbsp;&nbsp;&nbsp;&nbsp;册&nbsp;</button> -->
          <input   name="" onclick="window.location.href='pregUI'" class="btn btn-success radius size-L" type="button" class="btn btn-success radius size-L" value="&nbsp;注&nbsp;&nbsp;&nbsp;&nbsp;册&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       	  <input  name="" onclick="window.location.href='backpwdui'" type="button" class="btn btn-success radius size-L" value="&nbsp;找回密码&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
      </div>
    </form>
