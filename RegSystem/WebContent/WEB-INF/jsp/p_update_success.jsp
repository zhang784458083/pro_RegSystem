...
<section id="single">
	...
	<div class="cat_title">
		<div class="wrapper">
			<h2>修改资料状态</h2>
			 <p><br/><br/><font size="3px">修改资料成功</font></p> 
		</div>
	</div> 
	...
	<form action="#" method="post" class="form form-horizontal" id="form-member-add"> 
        ...
        <div class="formControls col-xs-8">
          ...
          <span><font color="blue" size="6px">恭喜您，已经修改成功！</font></span>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input onclick="window.location.href='orderUI'" class="btn btn-success radius size-L" type="button" value="&nbsp;开始预约&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
