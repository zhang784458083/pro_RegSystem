...
<section id="single">
	...
	<div class="cat_title">
		<div class="wrapper">
			<h2>请您认真填写</h2>
			 <p><br/><br/><font size="3px">您的专属预约订单</font></p> 
		</div>
	</div> 
	...
	<form action="${pageContext.request.contextPath}/pro_order" method="post" class="form form-horizontal" id="form-member-add" onsubmit="return checkForm()">
		<div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red" ></span>您选择的科室</label>
      ...
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red" ></span>您的预约时间</label>
        <div class="formControls col-xs-8">
      ...
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red" ></span>您的专属医生</label>
        <div class="formControls col-xs-8">
          <span><font color="black" size="4px">${d}</font></span>
        	
        </div>
     	
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red" >*</span>您的病情描述</label>
        <div class="formControls col-xs-8">
      ...
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red" ></span>本次挂号费用</label>
        <div class="formControls col-xs-8">
          <span><font color=blue size="4px" id="cost">5</font><font color=blue size="4px">元</font></span>
         
        </div>
     	
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red" ></span>本次支付方式</label>
        <div class="formControls col-xs-8">
         ...
         <span ><font color="red" size="3px">&nbsp;目前仅支持该方式，请确保余额充足！</font></span>
        </div>
        ...
        <div class="formControls col-xs-8 ">
          ...
          <img src="${pageContext.request.contextPath}/codeServlet" id="newcode"> <a id="kanbuq" href="javascript:;" >看不清，换一张</a> <br><font color="red" size="4px" >${message}</font></div>
...
function checkForm() {
    ...
    if (window.confirm("预约后不可取消，你确认提交吗?")) {
     return true;
    }
    return false;
   }
