...
<div class="row cl" style="margin-left: 150px">
      ...
      <div class="row cl" style="margin-left: 150px">
        	<label class="form-label col-xs-4 col-sm-3">出诊专家</label>
        <div class="formControls col-xs-8">
					<span>
      ...
      <div class="row cl" style="margin-left: 200px">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;检索专家出诊表&nbsp;&nbsp;" id="submit" onclick="return check()">
			</div>
...
var arr_province = ["请选择","眼科","骨科","儿科","内科"];
var arr_city = [
                ["请选择"],
                ["张","王"],
                ['李'],
