...
<section id="single">
	...
	<form action="${pageContext.request.contextPath}/preg" method="post" class="form form-horizontal" id="form-member-add"><br><p></p>
		<input id="pt" class="btn btn-primary radius" type="button" value="&nbsp;&nbsp;普通号&nbsp;&nbsp;" style="width:290px;height:300px;font-size: 50px;margin-left: 150px" onclick="javascript:window.location.href='generalUI'">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input id="zj" class="btn btn-success radius" type="button" value="&nbsp;&nbsp;专家号&nbsp;&nbsp;" style="width:290px;height:300px;font-size: 50px"  onclick="javascript:window.location.href='expertUI'">
