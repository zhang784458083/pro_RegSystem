...
<section id="single">
	...
	<form action="${pageContext.request.contextPath}/porder" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><img alt="" src="${pageContext.request.contextPath}/client/2.png" style="width: 65px;height: 65px"> </label>
        <div class="formControls col-xs-8">
        
          <span><font color="blue" size="6px">Sorry, the reservation failed!</font></span>
        	<%-- <input type="hidden" id="officeVal" value="${officeVal}"/> --%>
        </div>
     	
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red" ></span>Reasons for reservation failure:</label>
        <div class="formControls col-xs-8">
         <!--  <span><font color=black size="4px">同一时间段您的预约有冲突，建议您重新预约！</font></span> -->
          <span><font color=black size="4px">${reason }</font></span>
        </div>
    ...
    <div class="row cl">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				...
				<input onclick="window.location.href='orderUI'" class="btn btn-success radius size-L" type="button" class="btn btn-success radius size-L" value="&nbsp;appointment&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input onclick="window.location.href='orderUI'" class="btn btn-success radius size-L" type="button" value="&nbsp;Online top-up&nbsp;">
			</div>
		</div>
	</form>
