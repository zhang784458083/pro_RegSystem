...
<title>Login personal center</title>
...
<section id="single">
	...
	<article class="serv_detailed">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input  id="submit" name="" onclick="" type="submit" class="btn btn-success radius size-L" value="&nbsp;Login&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <input   name="" onclick="window.location.href='pregUI'" class="btn btn-success radius size-L" type="button" class="btn btn-success radius size-L" value="&nbsp;Regist&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       	  <input  name="" onclick="window.location.href='backpwdui'" type="button" class="btn btn-success radius size-L" value="&nbsp;Retrieve password&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
      </div>
    </form>
