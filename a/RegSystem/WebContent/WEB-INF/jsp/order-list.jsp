...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> Home <span class="c-gray en">&gt;</span>挂号管理 <span class="c-gray en">&gt;</span> Order list <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
<form class="form form-horizontal" action="${pageContext.request.contextPath}/findO" method="post">
	<div class="text-c">time：
		...
		<input type="text" class="input-text" style="width:150px" placeholder="Order ID" id="" name="orderid">
		<input type="text" class="input-text" style="width:100px" placeholder="Doctor" id="" name="dname">
		...
		<select name="state" class="select" style="width:100px" size="1">
			...
			<option value="1">To diagnose</option>
			<option value="2">Has been diagnosed</option>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td >${n.runendtime}</td>
				<c:if test="${n.state==1}">
					<td style="color: red">To diagnose</td>
				</c:if>
				<c:if test="${n.state==2}">
					<td >Has been diagnosed</td>
				</c:if>
				<td >${n.finshtime}</td>
