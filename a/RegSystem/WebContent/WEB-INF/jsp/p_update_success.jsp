...
<title>Modified data successfully</title>
...
<section id="single">
	...
	<div class="cat_title">
		<div class="wrapper">
			<h2>Modify data status</h2>
			 <p><br/><br/><font size="3px">Modified data successfully</font></p> 
		</div>
	</div> 
	...
	<form action="#" method="post" class="form form-horizontal" id="form-member-add"> 
        ...
        <div class="formControls col-xs-8">
          ...
          <span><font color="blue" size="6px">Congratulations, it has been modified successfully!</font></span>
