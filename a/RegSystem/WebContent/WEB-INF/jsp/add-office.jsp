...
<article class="page-container">
	<form class="form form-horizontal" method="POST" action="${pageContext.request.contextPath}/addOffice">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>The name of the department：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="articletitle" name="office">
			</div>
		</div>
		<!-- <div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">Introduction：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
