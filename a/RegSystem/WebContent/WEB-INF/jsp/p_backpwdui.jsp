...
<section id="single">
	...
	<div class="cat_title">
		<div class="wrapper">
			<h2><strong>Retrieve password</strong></h2>
			<!-- <p>个人中心<br/>关于我的一切</p> -->
		</div>
	</div> 
	...
	<article class="serv_detailed">
		...
		<!-- <div id="loginform" class="loginBox"> -->
		  <form class="form form-horizontal" action="${pageContext.request.contextPath}/backpwd" method="post" onsubmit="return checkForm()">
      <div class="row cl">
      ...
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>New</label>
        <div class="formControls col-xs-8">
      ...
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>Sure New</label>
        <div class="formControls col-xs-8">
      ...
      <div class="row cl">
			...
			<div class="formControls col-xs-8 ">
				<input type="text" class="input-text" value="182" placeholder="" id="tel" name="tel" disabled="disabled">
				<br/>
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input  id="submit" name="" onclick="" type="submit" class="btn btn-success radius size-L" value="&nbsp;Retrieve password&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <!-- <input   name="" onclick="window.location.href='pregUI'" class="btn btn-success radius size-L" type="button" class="btn btn-success radius size-L" value="&nbsp;注&nbsp;&nbsp;&nbsp;&nbsp;册&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
