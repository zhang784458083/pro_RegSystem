...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> Home <span class="c-gray en">&gt;</span>Registration management <span class="c-gray en">&gt;</span> 订单列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td >${n.runendtime}</td>
				<c:if test="${n.state==1}">
					<td ><a title="编辑" href="${pageContext.request.contextPath}/dEditOrderUi?orderid=${n.orderid}" style="color: red">To diagnose</a></td>
				</c:if>
				<c:if test="${n.state==2}">
