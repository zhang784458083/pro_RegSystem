...
<section id="single">
	...
	<form action="${pageContext.request.contextPath}/porder" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="formControls col-xs-8">
          ...
          <span><font color="blue" size="6px">Sorry, failed recharge!</font></span>
        	<%-- <input type="hidden" id="officeVal" value="${officeVal}"/> --%>
        </div>
     	
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red" ></span>充值失败原因：</label>
        <div class="formControls col-xs-8">
          <span><font color=black size="4px">Bank card balance insufficient!</font></span>
        </div>
    ...
    <div class="row cl">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				...
				<input onclick="window.location.href='paccount'" class="btn btn-success radius size-L" type="button" class="btn btn-success radius size-L" value="&nbsp;To prepaid phone&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</div>
		</div>
	</form>
