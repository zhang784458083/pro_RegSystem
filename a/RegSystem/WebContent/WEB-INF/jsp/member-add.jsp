...
<section id="single">
	...
	<form action="${pageContext.request.contextPath}/add" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
		...
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>bir：</label>
			...
			<input type="text" onfocus="WdatePicker({ maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}' })" id="birthday" name="birthday" class="input-text Wdate" style="width:120px;">
			</div>		
		</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">city：</label>
...
<!--请在下方写此页面业务相关的脚本--> 
<script type="text/javascript" src="lib/My97DatePicker/4.8/calendar.js"></script>
