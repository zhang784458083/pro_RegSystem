...
<font size="6px" style="margin-left: 360px;">Community hospital management platform</font>
    ...
    <form class="form form-horizontal" action="${pageContext.request.contextPath}/mlogin" method="post">
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input id="username" name="username" type="text" placeholder="username" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 ">
          ...
          <img src="${pageContext.request.contextPath}/codeServlet" id="newcode"> <a id="kanbuq" href="javascript:;" >Another captcha</a> </div>
      </div>
     <%--  <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <input name="" type="reset" class="btn btn-default radius size-L" value="&nbsp;Cancel&nbsp;"><br>
        </div>
      </div>
    </form>
...
<div class="footer">2017-2018 @Copyright Striving youth is the most beautifulBeta2.0</div>
