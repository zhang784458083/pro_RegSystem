...
<section id="single">
	...
	<div class="cat_title">
		<div class="wrapper">
			<h2>Registration status</h2>
			 <p><br/><br/><font size="3px">Welcome to experience this platform</font></p> 
		</div>
	</div> 
	...
	<form action="#" method="post" class="form form-horizontal" id="form-member-add"> 
        ...
        <div class="formControls col-xs-8">
          ...
          <span><font color="blue" size="6px">Congratulations, you have registered successfully!</font></span>
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <span><font color=black size="4px">Welcome you to become our honorable user, 5 yuan voucher has been charged to your account!</font></span>
        </div>
       ...
       <!--  <label class="form-label col-xs-4 col-sm-3"><span class="c-red" >*请您牢记，</span></label> -->
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input onclick="window.location.href='ploginUI'" class="btn btn-success radius size-L" type="button" value="&nbsp;Try booking right away&nbsp;">
			</div>
		</div>
	 </form> 
