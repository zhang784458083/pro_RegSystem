...
<![endif]-->
<title>Visits to manage</title>
</head>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> Home <span class="c-gray en">&gt;</span>Visits to manage <span class="c-gray en">&gt;</span>Visits <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
<form class="form form-horizontal" action="${pageContext.request.contextPath}/findChuzhen" method="post">
	<div class="text-c">VisitTime：
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">  <a class="btn btn-primary radius" data-title="安排出诊" data-href="addChuzhenUI" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> Add to arrange</a></span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th width="14%">end</th>
				<th width="6%">max</th> 
				<th width="6%">Booking capacity</th> 
...
Ordinary doctor</td>
				...
				<td >${n.maxregis}</td>
				<td >${n.canregis}</td>
				<td><a title="编辑" href="javascript:;" onclick="member_edit('editor','edit-chuzhen?vid=${n.vid}','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a></td>
			</tr> 
			</c:forEach>
