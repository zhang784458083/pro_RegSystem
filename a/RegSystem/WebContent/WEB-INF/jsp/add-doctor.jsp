...
<article class="page-container">
	<form class="form form-horizontal" method="POST" action="${pageContext.request.contextPath}/addDoctor">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="role" class="select">
					<option value="1">Ordinary doctor</option>
					<option value="2">experts</option>
				</select>
				</span> </div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>department：</label>
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>UserName：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>Place：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="articletitle" name="place">
			</div>
		</div>
		<!-- <div class="row cl">
