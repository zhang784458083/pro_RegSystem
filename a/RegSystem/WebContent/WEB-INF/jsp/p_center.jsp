...
<section id="single">
	...
	<div class="cat_title">
		<div class="wrapper">
			<h2><strong>Personal center</strong></h2>
			<p>View<br/>Record</p>
		</div>
		<div style="margin-left: 800px">
			
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="btn btn-primary radius" type="button" value="&nbsp;&nbsp;Account&nbsp;&nbsp;" onclick="window.location.href='paccount'">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="btn btn-primary radius" type="button" value="&nbsp;&nbsp;Modify&nbsp;&nbsp;" onclick="window.location.href='personUI'">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="btn btn-primary radius" type="button" value="&nbsp;&nbsp;Password reset&nbsp;&nbsp;" onclick="window.location.href='resetpwdUI'">
		</div>
	...
	<article class="serv_detailed">
    	...
    	<c:if test="${empty entityOrderList}">
         		 <span><font color="blue" size="6px" style="margin-left: 250px"> You have no record of reservation at present！</font></span>
			</c:if>
    	<c:forEach items="${entityOrderList }" var="e">
    		 
    		<div class="wrapper">
      		<h4><font size="3px">ID：${e.oid }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Time：${e.regtime }</font></h4>
      		<span>
      			<font size="3px" style="margin-left: 0px" color="black">Department：${e.oname }</font>
      			<font size="3px" style="margin-left: 50px" color="black">Doctor：${e.dname }</font>
      			<font size="3px" style="margin-left: 50px" color="black">Palce：${e.place}</font>
      			<font size="3px" style="margin-left: 50px" color="black">Description：${e.desc}</font><br>
      			<font size="3px" style="margin-left: 0px" color="black">State：${e.state}</font>
      			<font size="3px" style="margin-left: 32px" color="black">Clinical time：${e.starttime}&nbsp;&nbsp;&nbsp;&nbsp;${e.endtime}</font>
