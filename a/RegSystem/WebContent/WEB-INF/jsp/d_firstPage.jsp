...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" >community<font size="4">&nbsp;e&nbsp;</font>Registered monitoring platform&nbsp;(doctor)</a> <!-- <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>  -->
			...
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					...
					<ul class="dropDown-menu menu radius box-shadow">
						...
						<li><a href="logout">Switch account</a></li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> Registration management<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="d-order-list" data-title="Registration is" href="javascript:void(0)">Registration is</a></li>
			</ul>
		</dd>
	</dl>
	<!-- <dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="findOffice" data-title="科室管理" href="javascript:void(0)">科室管理</a></li>
			</ul>
		</dd>
	</dl>
	<dl id="menu-admin">
	...
	<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> Visits to manage<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="d-chuzhen" data-title="visits" href="javascript:void(0)">visits</a></li>
			</ul>
		</dd>
	</dl>
	<!-- <dl id="menu-member">
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					<li><a data-href="d-about" data-title="Personal information" href="javascript:void(0)">Personal information</a></li>
	...
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="My desktop" data-href="zhuomian.jsp">My desktop</span>
					<em></em></li>
		</ul>
	</div>
