...
<title>Successful password modification</title>
...
<section id="single">
	...
	<div class="cat_title">
		<div class="wrapper">
			<h2>Change password status</h2>
			 <p><br/><br/><font size="3px">Successful password modification</font></p> 
		</div>
	</div> 
	...
	<form action="#" method="post" class="form form-horizontal" id="form-member-add"> 
        ...
        <div class="formControls col-xs-8">
          ...
          <span><font color="blue" size="6px">Congratulations on your password change！</font></span>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input onclick="window.location.href='orderUI'" class="btn btn-success radius size-L" type="button" value="&nbsp;Began to make an appointment&nbsp;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
