...
<article class="page-container">
	<form class="form form-horizontal" method="POST" action="${pageContext.request.contextPath}/updateoffice">
		<input type="hidden" value="${o.oid}" name="oid"/>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>The name of the department：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${o.oname}" placeholder="" id="articletitle" name="office" disabled="disabled">
			</div>
		</div>
		<!-- <div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">Introduction of department：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
				<!-- <script id="editor" type="text" style="width:100%;height:400px;" ></script>  -->
				<textarea rows="3" cols="50" name="desc"> ${o.odesc}</textarea>
			</div>
		</div>
		<div class="row cl">
