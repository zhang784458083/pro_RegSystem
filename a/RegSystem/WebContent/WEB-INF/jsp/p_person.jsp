...
<section id="single">
	...
	<div class="cat_title">
		<div class="wrapper">
			<h2>My center</h2>
			 <p><br/><br/><font size="3px">Update</font></p> 
		</div>
	</div> 
	...
	<form action="${pageContext.request.contextPath}/update" method="post" class="form form-horizontal" id="form-member-add" onsubmit="return aa()">
     ...
     <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3">Username</label>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input class="btn btn-primary radius" type="submit" value="&nbsp;&nbsp;Update&nbsp;&nbsp;" >
			</div>
		</div>
