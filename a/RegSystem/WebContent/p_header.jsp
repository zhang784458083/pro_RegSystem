...
<header>
	...
	<div class="wrapper">
		<h1 class="logo">
			...
			<font size="6" color="white">E-registered platform</font>
		</h1>
		<nav>
			<ul>
				<li class="home"><a href="pindex" >Home page<span>website homepage</span></a></li>
				<c:if test="${not empty patient }">
					<li class="about"><a href="orderUI" title="Platform services">Online booking<span>
What can we do </span></a></li>
				</c:if>
				<c:if test="${empty patient }">
					<li class="about"><a href="ploginUI" title="Platform services ">Online booking<span>What can we do </span></a></li>
				</c:if>
				<li class="cases"><a href="sysabout" title="Booking information">Booking information<span>How do you do that</span></a></li>
				<li class="service"><a href="news" title="News">The latest announcement<span>discontinue information </span></a></li>
				
				<c:if test="${not empty patient }">
				<li class="client"><a href="pcenter"  title="Personal center">welcome：${patient.pname}<span>
My accoun</span></a></li>
				<li class="client"><a href="plogout"  title="Log out">Log out<span>Log back in</span></a></li>
				</c:if>
				<c:if test="${empty patient }">
				<li class="client"><a href="ploginUI"  title="Personal center">Login personal center<span>registered</span></a></li>
