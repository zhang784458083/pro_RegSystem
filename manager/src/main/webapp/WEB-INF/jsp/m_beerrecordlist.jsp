...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>营销记录管理 <span class="c-gray en">&gt;</span> 啤酒记录<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
<form class="form form-horizontal" action="${pageContext.request.contextPath}/m_beerrecordlist" method="post">
	 <div class="text-c"> 
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th width="30">参与活动</th>
				<th width="20">支付方式</th>
				<th width="20">原有数量(瓶)</th>
				<th width="20">变动数量(瓶)</th>
				<th width="20">现有数量(瓶)</th>
				<th width="20">操作员</th>
			</tr>
		</thead>
		<tbody>
