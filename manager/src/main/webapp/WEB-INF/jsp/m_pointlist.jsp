...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>会员营销管理 <span class="c-gray en">&gt;</span> 积分管理<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
<form class="form form-horizontal" action="${pageContext.request.contextPath}/m_pointlist" method="post">
	 <div class="text-c"> 
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<c:forEach items="${list}" var="n" >
				...
				<td class="td-manage">
					<a title="充值积分" href="javascript:;" onclick="member_edit('充值积分','addpointui?id=${n.user_id}','4','','510')" class="ml-5" style="text-decoration:none">积分</a>
					<a title="积分兑换" href="javascript:;" onclick="member_edit('兑换积分','reducepointui?id=${n.user_id}','4','','510')" class="ml-5" style="text-decoration:none">兑换</a>
			    </td>
			</tr>
			</c:forEach>
