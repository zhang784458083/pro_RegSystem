...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>用户信息管理 <span class="c-gray en">&gt;</span> 顾客管理<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
<form class="form form-horizontal" action="${pageContext.request.contextPath}/m_userlist" method="post">
	 <div class="text-c"> 
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<c:forEach items="${list}" var="n" >
				...
				<td>${n.user_intergal }</td>
				<td>${n.user_sum }</td>
				<c:if test="${loginUser.type==2 }">
					<td class="td-manage">
						 <a title="编辑用户信息" href="javascript:;" onclick="member_edit('编辑','edituserui?id=${n.user_id}','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a title="删除" href="javascript:;" onclick="member_del(this,'${n.user_id}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a> 
			    	</td>
				</c:if>
			</tr>
			</c:forEach>
