...
<font size="6px" style="margin-left: 530px;">梁氏大虾营销管理系统</font>
  <div id="loginform" class="loginBox">
  
    <form class="form form-horizontal" action="${pageContext.request.contextPath}/manaindex" method="post">
     ...
     <div class="row cl">
        ...
        <div class="formControls col-xs-8 ">
        	 <input type="radio" id="radio-1" name="type" checked value="1">
    					 <label for="radio-1">操作员</label>
    		<input type="radio" id="radio-1" name="type" value="2" style="margin-left: 20px">
...
<div class="footer">2019 @Copyright 晋备字  版权所有</div>
