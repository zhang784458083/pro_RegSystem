...
<div class="container"> 		
		...
		<div class="banner_erji">
        	...
        	<img src="${pageContext.request.contextPath}/images/about.png" width="1000" height="187" alt="" title="">
        ...
        <li><h3><a href="leave">给我留言</a></h3>

</li>

        

        <li><h3><a href="about">团队介绍</a></h3>

</li>

        

        <li><h3><a href="connection">联系我们</a></h3>
        	...
        	<div class="rightbar">
            	...
            	<div class="bread"><a href="index">首页</a> > 团队介绍</div>
